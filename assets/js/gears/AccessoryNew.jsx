...
const AccessoryNew = ({ onlineUser }) => {
        ...
        try {
            await instance
                .post(endPoint, {
                    ...
                    visibility: vsblt,
                    visibleToGroups: selectedGroups.map((g) => `/api/groups/${g.id}`),
                })
    ...
    const handleSubmit = (e) => {
        ...
        //console.log("Formulaire accessory soumis :", formData);
        postData(accessoryNewEndPoint);
    };
    ...
    const accessoryNewEndPoint = "/accessories";
