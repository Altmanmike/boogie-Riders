...
const Article = () => {
            ...
            member: [
                {
                    ...
                    createdAt: "2025-08-21T11:55:43+02:00",
                    updatedAt: "2025-08-21T11:55:43+02:00",
                    user: "/api/users/1",
                    comments: ["/api/comments/1", "/api/comments/2"],
                    likes: ["/api/likes/1"],
                    medias: ["/api/media/1", "/api/media/2"],
                    visibility: "Public",
                    visibleToGroups: [],
                },
                {
    ...
    const articles = articleList[0].member;
        ...
        <>
            <div className="container mx-auto h-full mb-100">
                <div className="flex justify-center items-center gap-5 mt-10">
                    ...
                    <a className="btn btn-sm btn-neutral" href="/articleNew">
                        Add new
                    </a>
                </div>
                {selectedItem ? (
